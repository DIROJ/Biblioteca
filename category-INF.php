...
<head>
    ...
    <title>Libros Infantiles</title>                                          <!--Modificar Titulo de Página-->
    <meta charset="UTF-8">
    ...
    <meta name="description" content="En esta página se encuentran los libros del género Infantiles">
...
<?php
    ...
    $sql = "SELECT `Autor`, `Titulo`, `Editorial`, `Fecha`, `ISBN`, `Descripcion` FROM `libros` WHERE Genero = 'Infantiles'";
