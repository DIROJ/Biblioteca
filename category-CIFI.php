...
<head>
    ...
    <title>Libros de Ciencia Ficción</title>                                          <!--Modificar Titulo de Página-->
    <meta charset="UTF-8">
    ...
    <meta name="description" content="En esta página se encuentran los libros del género Ciencia Ficción">
...
<?php
    ...
    $sql = "SELECT `Autor`, `Titulo`, `Editorial`, `Fecha`, `ISBN`, `Descripcion` FROM `libros` WHERE Genero = 'Ciencia Ficción'";
...
<body id="cuerpo">
    ...
    <main>
       <div class="cont">
            <h1 class="head">Ciencia Ficción</h1>
            <ul>
            <?php
                $index = 0;
                while ($index < 15){
